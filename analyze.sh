...
UPLOADDIR=/Users/username/Desktop/03-uploads-sanitized-sources-models
...
## RestifyJupyter visualization project: https://github.com/anonymous4doubleblinded/RestifyJupyter
CSVREPORT=tests.csv

## Reference to the cloned sources of the Xox REST unit tests.
## Origin: https://github.com/anonymous4doubleblinded/XoxStudyRestTest
XOXTESTDIR=/Users/username/Code/XoxStudyRestTest

## Reference to the cloned sources of the BookStore REST unit tests.
## Origin: https://github.com/anonymous4doubleblinded/BookStoreRestTest
BSTESTDIR=/Users/username/Code/BookStoreRestTest
...
function usage {
  ...
  echo "https://github.com/anonymous4doubleblinded/RestifyAnalyzer"
  echo "(c) M.Researcher, University University 2023"
}
